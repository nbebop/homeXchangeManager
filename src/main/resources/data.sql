...
VALUES ('1', '1', 'Small cozy loft in the center of paris', 'Any other info call me', 5, 0, '2024-01-01', '2024-12-01', 'Brown 69', '4th floor, left', 'Paris', '750001', 'France'),
       ...
       ('13', '13', 'Modern house in Houston', 'Contact owner for availability and reservations', 5, 0, '2024-07-01', '2024-12-31', '456 Pine St', 'Premise 4', 'Houston', '78901', 'USA'),
       ('14', '14', 'Beachfront villa in Sevilla', 'Please inquire for booking details', 4, 0, '2024-08-01', '2024-12-31', '789 Maple St', 'Premise 5', 'Sevilla', '34567', 'Spain'),
       ('15', '15', 'Spacious apartment in Tokyo', 'Contact me for booking details', 5, 0, '2024-09-01', '2024-12-31', '15 Ichiban Street', 'Premise 6', 'Tokyo', '34375', 'Japan'),
       ('16', '16', 'Luxurious penthouse in San Francisco', 'For bookings, contact the owner', 3, 0, '2024-10-01', '2024-12-31', '45 Guitar street', 'Premise 7', 'San Francisco', '84735', 'USA'),
       ('17', '17', 'Stylish apartment in Oviedo', 'For booking inquiries, please contact the owner', 4, 0, '2024-11-01', '2024-12-31', '33 Win Street', 'Premise 8', 'Oviedo', '41008', 'Spain'),
       ('18', '18', 'Cozy apartment in Paris', 'Contact owner for availability and reservations', 3, 0, '2024-12-01', '2024-12-31', '32 admin street', 'Premise admin', 'Paris', '750015', 'France'),
       ('19', '19', 'Modern loft in Madrid', 'Please inquire for booking details', 4, 0, '2024-08-01', '2024-12-31', '32 admin street', 'User ', 'Madrid', '750015', 'Spain'),
       ('20', '20', 'Modern loft in Madrid', 'Please inquire for booking details', 5, 0, '2024-08-01', '2024-12-31', '32 admin street', 'User', 'Madrid', '750015', 'Spain'),
       ('21', '21', 'Cozy apartment in New York', 'For booking inquiries, please contact the owner', 5, 0, '2024-06-01', '2024-12-31', '123 Elm St', 'Premise 12', 'New York', '10001', 'USA'),
       ('22', '22', 'Modern apartment in London', 'Please inquire for booking details', 5, 0, '2024-07-01', '2024-12-31', '123 Oxford St', 'Premise 12', 'London', 'W1A 1AA', 'United Kingdom'),
       ('23', '23', 'Luxurious penthouse in Sydney', 'For bookings, contact the owner', 4, 0, '2024-08-01', '2024-12-31', '456 George St', 'Premise 12', 'Sydney', '2000', 'Australia'),
       ('24', '24', 'Stylish villa in Melbourne', 'For booking inquiries, please contact the owner', 3, 0, '2024-09-01', '2024-12-31', '789 Collins St', 'Premise 12', 'Melbourne', '3000', 'Australia'),
       ('25', '25', 'Cozy apartment in Auckland', 'Contact owner for availability and reservations', 4, 0, '2024-10-01', '2024-12-31', '123 Queen St', 'Premise 12', 'Auckland', '1010', 'New Zealand'),
       ('26', '26', 'Modern loft in Singapore', 'Please inquire for booking details', 3, 0, '2024-11-01', '2024-12-31', '32 Vettel street', 'Premise admin', 'Singapore', '10000', 'Singapore'),
       ('27', '27', 'Modern loft in Hong Kong', 'Please inquire for booking details', 4, 0, '2024-12-01', '2024-12-31', '32 binchiling street', 'User ', 'Hong Kong', '99907', 'Hong Kong'),
       ('28', '28', 'Modern loft in Tokyo', 'Please inquire for booking details', 5, 0, '2024-08-01', '2024-12-31', '32 Naruto street', 'User', 'Tokyo', '34375', 'Japan'),
       ('29', '29', 'Modern loft in Seoul', 'Please inquire for booking details', 5, 0, '2024-08-01', '2024-12-31', '33 BTS street', 'User', 'Seoul', '06000', 'South Korea'),
       ('30', '30', 'Modern loft in Beijing', 'Please inquire for booking details', 4, 0, '2024-08-01', '2024-12-31', '32 Haiki street', 'User', 'Beijing', '100000', 'China');
